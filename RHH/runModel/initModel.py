...
## Old initializing basic model, used for generating arcs
### Basic model
def initialize_basic_model_and_arcs(group, filename):
    ...
    generate_arcs = True #Hardkodet
    write_arcs = True #Hardkodet
    if generate_arcs:
